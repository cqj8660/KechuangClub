...
<script>
import { getActivityDetail, cancelAccept } from "../../request/api"; // 导入我们的api接口
...
export default {
  ...
  methods: {
    onCancel: function () {
      console.log(this.a_id, this.openId);
      let params = { a_id: this.a_id, openId: this.openId };
      var that = this;
      cancelAccept(params).then((res) => {
